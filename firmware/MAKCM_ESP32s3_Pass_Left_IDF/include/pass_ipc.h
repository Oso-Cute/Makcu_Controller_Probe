...
// Stability-test default. Both firmware projects include this protocol
// constant; override both builds with -DPASS_IPC_UART_BAUD=5000000UL to
// compare against the original 5 Mbps link without editing endpoint logic.
