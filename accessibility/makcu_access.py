...
class Makcu:
    ...
    def version(self):
        ...
        # A diagnostic firmware can be writing [L]/[R] logs on the same UART.
        # Drain old output, then scan for the identification line rather than
        # assuming the first bytes read belong to our request.
